 ...
 *
 * `@UnitOfWork` annotation provided by the drop-wizard only works in a
 * (End-point)Resource class.
 *
 * This uses ManagedSessionContext to check if this thread already has a
 * transaction session and re-uses it if needed
 */
